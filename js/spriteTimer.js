    ...
    $.fn.spriteTimer = function(options) {
        ...
        var SpriteTimer = {
            ...
            isNewDigitNeeded: function() {
                ...
                if (s == 10 || s == 60 || s == 600 || s == 3600 || s == 36000 || s == 86400 || s == 864000) {
                    return true;
                }
                return false;
            },
            updateTime: function(seconds) {
                ...
                if (self.numDigits == 7) {
                    ...
                    myVal = numHours % 24;
                    if (myVal > 9) {
                        self.setDigit(self.digits[n-5], parseInt(String(myVal).charAt(1), 10));
                    } else {
                        self.setDigit(self.digits[n-5], parseInt(String(myVal).charAt(0), 10));
                    }
                    if (myVal < 10) {
                        self.setDigit(self.digits[n-6], 0);
                    } else {
            ...
            populateTimer: function() {
                ...
                toInject += '<' + settings.digitElement + ' class="digit"></' + settings.digitElement + '>';
                ...
                for (var i = 0; i < self.numDigits; i++) {
                    ...
                    if (self.numDigits == 7 && i == 2 || self.numDigits == 7 && i === 4 || self.numDigits == 7 && i === 0) {
                        toInject += '<' + settings.separatorElement + ' class="colon"></' + settings.separatorElement + '>';
                    }
                }
            ...
            updateNumDigits: function(addAnother) {
                ...
                if (num > self.numDigits || addAnother) {
                    numDigits = num;
                    timerElm.append('<' + settings.digitElement + ' class="digit"></' + settings.digitElement + '>');
                    if (num > 2 && num < 5) {
